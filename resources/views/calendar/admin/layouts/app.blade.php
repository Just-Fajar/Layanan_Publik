...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('images/logo-web-event-madiun.jpg') }}">
        ...
        <div>
            <div class="p-5 border-b border-slate-800 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-lg font-bold tracking-wide">Calendar Admin</span>
                </div>
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-white border-b border-gray-200 px-4 md:px-6 py-4 flex items-center justify-between shadow-sm">
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('admin.dashboard') }}" class="text-xs md:text-sm font-semibold text-gray-500 hover:text-purple-600">
            ...
            <div class="flex items-center space-x-2 md:space-x-4">
                @if(Auth::guard('admin')->check())
                    <div class="text-right">
                        ...
                        <div class="text-[10px] md:text-xs text-purple-600 capitalize font-medium">{{ Auth::guard('admin')->user()->role }}</div>
                    </div>
