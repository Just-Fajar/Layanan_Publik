            ...
            <form action="{{ route('calendar.admin.events.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" required placeholder="Contoh: Sosialisasi SPBE Madiun">
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Contoh: Gedung GCIO Diskominfo">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control" rows="5" required placeholder="Deskripsi lengkap mengenai agenda kegiatan...">{{ old('description') }}</textarea>
                    </div>

                    <div class="col-12">
                        <label class="form-label fw-bold">Banner / Gambar Event (Opsional)</label>
